...
`SecureUserService` главный сервис данной статьи - то, ради чего она задумывалась. Эксперимент по пониманию в смысла такой простой и в тоже время насущной для новичка темы. 
